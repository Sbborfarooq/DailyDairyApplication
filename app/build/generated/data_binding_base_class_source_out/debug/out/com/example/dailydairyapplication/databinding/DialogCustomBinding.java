...
public final class DialogCustomBinding implements ViewBinding {
  ...
  private DialogCustomBinding(@NonNull ConstraintLayout rootView, @NonNull TextView ExitBar,
      @NonNull Button buttonNo, @NonNull Button buttonYes, @NonNull TextView dialogMessage) {
  ...
  public static DialogCustomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.Exit_bar;
      TextView ExitBar = ViewBindings.findChildViewById(rootView, id);
      if (ExitBar == null) {
        break missingId;
      }
      ...
      return new DialogCustomBinding((ConstraintLayout) rootView, ExitBar, buttonNo, buttonYes,
          dialogMessage);
    }
