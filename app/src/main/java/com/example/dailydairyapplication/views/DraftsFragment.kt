...
import com.example.dailydairyapplication.databinding.FragmentDraftsBinding


class DraftsFragment : Fragment() {

    private lateinit var _binding: FragmentDraftsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.draftsbackArrow.setOnClickListener {
